...
const all_users = ({loaderData}: Route.ComponentProps) => {
  ...
  return (
    <main className="all-users wrapper">
      <Header title="Manage users" description="Filter, sort and acces detailed user profiles"/>

      <GridComponent dataSource={users} gridLines="None">
        <ColumnsDirective>
          {/*ColumnDirective -> Each individual row: fields matches the values of the datasource*/}
          ...
          <ColumnDirective field="joinedAt" headerText="Date Joined" width="150" textAlign="Left" template={({joinedAt}: {joinedAt:string}) => formatDate(joinedAt)}/>
